...
abstract class IFirestoreRepository {
  ...
  Future<String?> createWithId(String collectionName, String docId, Map<String, dynamic> data, [bool merge = false]);
  Future<DataWithId?> read(String collectionName, String documentId);
  Future<List<DataWithId>> readMultiple(String collectionName, List<String> documentIds);
  Future<bool> update(String collectionName, String documentId, Map<String, dynamic> data);
  Future<bool> delete(String collectionName, String documentId);
  
  // Query operations used by services
  Future<List<DataWithId>> queryByField(String collectionName, String field, dynamic value, {int? limit});
  
  // Array operations (used by ParentDataService)
  Future<bool> appendToArrayField(String collectionName, String docID, String field, dynamic value);
  ...
  Future<bool> updateFieldForSubcollection(String collectionName, String subcollectionName, 
      String docId, String subDocId, String field, dynamic value);
  Future<List<DataWithId>> readAllFromSubcollection(String collectionName, String docId, String subcollectionName);
  ...
  Future<bool> addOrUpdateWordTracker(
      ...
      String subDocId, WordTracker wordTracker);
