  ...
  return BottomAppBar(
    ...
    child: Row(
      ...
      IconButton(
        ...
        onPressed: () {
                if (currPage != "addtext") Navigator.pushNamed(context, '/addtext');
              },
      ),
      IconButton(
        icon: const Icon(
        ...
        onPressed: () {
            if (currPage != "uploadvideo") Navigator.pushNamed(context, '/uploadvideo');
            }
      ),
      IconButton(
        icon: const Icon(
      ...
      IconButton(
        ...
        onPressed: () {
              if (currPage != "settings") Navigator.pushNamed(context, '/settings');
              },
      ) 
        ],
      )
